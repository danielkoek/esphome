...
CONF_RF_SWITCH_PIN = "rf_switch_pin"
    ...
    cv.Schema(
        {
            ...
            cv.Required(CONF_RF_SWITCH_PIN): pins.gpio_output_pin_schema,
        }
...
async def to_code(config):
    ...
    rf_switch = await cg.gpio_pin_expression(config[CONF_RF_SWITCH_PIN])
    cg.add(var.set_rf_switch_pin(rf_switch))
